    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <ul>
                ...
                <li>Chuleta ahumada pz</li>
                <li>Jamón cocido</li>
                <li>Jamón cuadrado</li>
                <li>Jamón foodservice</li>
                <li>Jamón lunch</li>
                <li>Jamón virginia</li>
                <li>Puntas de tocino</li>
                <li>Salami cocido</li>
                <li>Salchicha para asar</li>
                <li>Salchichas foods</li>
                <li>Salchicha frankfort</li>
                <li>Salchicha hotdog</li>
            </ul>
        </div>
        <div class="col-md-4">
            <img src="img/salchichas.jpg" alt="" class="img-responsive img-circle">
        </div>
        <div class="col-md-4">
            <h3>Salchichas hot dog</h3>
            <p class="text-justify">
                Pieza de 2 kg.<br />
                Caja de 24 kg.<br />
                Usos: Hot dogs, frijoles charros, tacos y discada.<br />
                Parametro 0, 5, 20, 40 y 200 kg.<br />
                Categoría: Todo para su Negocio.
            </p>
            <img src="img/categorias/todo-para-su-negocio.png" alt="" class="img-responsive">
            <img src="img/categorias/reunion-especial.png" alt="" class="img-responsive">
        </div>
    </div>
    <div class="jumbotron">
      <div class="container">
